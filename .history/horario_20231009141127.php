...
#botao1.disabled, #botao2.disabled {
    background-color: gray; /* Cor de fundo cinza para botões desativados */
    cursor: not-allowed; /* Cursor de não permitido quando desativado */
}
